...
const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    path: '/analytics',
    icon: BarChart3,
    roles: ['farmers', 'roasters', 'hub-community'],
    category: 'core',
    section: 'core-farmers',
  },
  ...
  // Certification Section (Retailers)
  {
    ...
    roles: ['retailers'],
    category: 'traceability',
    section: 'certification-retailers',
  },
  {
    label: 'Traceability',
    path: '/traceability',
...
const sectionLabels: Record<string, string> = {
  ...
  'core-retailers': 'Core Section',
  'production-retailers': 'Production Section',
  'certification-retailers': 'Certification Section',
  'analytics-retailers': 'Analytics Section',
